...
class Game():
    ...
    def start_new_round(self):
        ...
        for col in range(11):
            for row in range(5):
                alien = Alien(64 + col * 64, 64 + row * 64, 2, self.alien_bullet_group)
                self.alien_group.add(alien)

        # Pause the game and prompt user to start
        self.new_round_sound.play()
        self.pause_game("New Round", f"Press 'Enter' to begin")
